...
<div id="drf1">Футбольный клуб "Эдем"</div>
<div id="sp1">
<ul id="ul1">
...
<div id="dr1">
	<h1 id="hr1"> Регистрация </h1>
		<form method="post" action='reg.php'>
			<p id="regp1">
			<input type="text" name="email" id="in1" placeholder="Ваша почта">
		</p>
			<br>
			<p id="regp1">
			
			
			<input type="text" name="username" id="in1" placeholder="Имя пользователя">
		</p>
			<br>
			<p id="regp1">
